...
"Classes for SQL tables to Python classes mapping for registration"

import datetime
import random
import re
import sha      #the sha module is deprecated in Python2.6
##import hashlib    Python2.6
...
class RegistrationProfile(models.Model):
    ...
    class Meta:
        "Special properties of the RegistrationProfile class"
