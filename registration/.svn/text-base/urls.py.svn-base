...
from django_logistics.registration.views import activate
from django_logistics.registration.views import register


urlpatterns = patterns('',
                       # Activation keys get matched by \w+ instead of the more 
                       #specific
                       # [a-fA-F0-9]{40} because a bad activation key should 
                       #still get to the view;
                       # that way it can return a sensible "invalid key" 
